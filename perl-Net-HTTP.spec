...
%prep
%setup -q -n Net-HTTP-6.23
cd %{_builddir}/Net-HTTP-6.23
pushd ..
cp -a Net-HTTP-6.23 buildavx2
popd
...
cp %{_builddir}/Net-HTTP-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Net-HTTP/55ea774e4ea0a1871dd8be781ec3dbfcce59ac8f || :
if test -f Makefile.PL; then

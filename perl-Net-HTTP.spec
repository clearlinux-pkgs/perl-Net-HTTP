...
%prep
%setup -q -n Net-HTTP-6.19
cd %{_builddir}/Net-HTTP-6.19
...
cp %{_builddir}/Net-HTTP-6.19/LICENSE %{buildroot}/usr/share/package-licenses/perl-Net-HTTP/6e6fb60587958e5351e6f08e2e2088afb70ac03d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Net/HTTP.pm
/usr/lib/perl5/vendor_perl/5.30.1/Net/HTTP/Methods.pm
/usr/lib/perl5/vendor_perl/5.30.1/Net/HTTP/NB.pm
/usr/lib/perl5/vendor_perl/5.30.1/Net/HTTPS.pm
